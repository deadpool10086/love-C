...
int main()
{
	...
	cout << "maximun size of vector2: " << vector2.max_size() << endl;
	vector1.swap(vector2);
	cout << "size of vector1: " << vector1.size() << endl;
	cout << "size of vector2: " << vector2.size() << endl;
	cout << boolalpha << "vector1 < vector2? " << (vector1 < vector2) << endl << endl;  //比较大小时类似字符串的比较。
	...
	cout << "maximun size of list2 " << list2.max_size() << endl;
	list1.swap(list2);
	cout << "size of list1: " << list1.size() << endl;
	cout << "size of list2: " << list2.size() << endl;
